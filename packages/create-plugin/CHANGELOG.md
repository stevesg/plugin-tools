...
* bump go version and dependencies in backend templates ([#2679](https://github.com/grafana/plugin-tools/issues/2679)) ([2c81fcd](https://github.com/grafana/plugin-tools/commit/2c81fcd1fa8d414119e280d2e22b50aef72d87fa))
...
- chore(deps): update dependency @grafana/plugin-e2e to v3.5.0 [#2574](https://github.com/grafana/plugin-tools/pull/2574) ([@renovate-sh-app[bot]](https://github.com/renovate-sh-app[bot]))
...
- chore(deps): update dependency @grafana/plugin-e2e to v3.3.0 [#2452](https://github.com/grafana/plugin-tools/pull/2452) ([@renovate-sh-app[bot]](https://github.com/renovate-sh-app[bot]))
